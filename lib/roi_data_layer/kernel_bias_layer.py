...
class KernelBiasLayer(caffe.Layer):
    ...
    def forward(self, bottom, top):
        ...
        bias_matrix = np.zeros((bottom_shape[0],bottom_shape[1],bottom_shape[2],bottom_shape[3]))
        bias_matrix[:,:, (bottom_shape[2] - 1)/2,(bottom_shape[2] - 1)/2] = (bottom_shape[0] +0.0)/ 16/bottom_shape[1]
        top[0].data[...] =bias_matrix
